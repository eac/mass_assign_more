...
module ActiveModel
  ...
  module MassAssignmentSecurity
    ...
    def self.included(base)
      base.send(:include, MassAssignMore::Compatibility)

      base.class_attribute :_accessible_attributes
      base.class_attribute :_protected_attributes
      base.class_attribute :_active_authorizer
